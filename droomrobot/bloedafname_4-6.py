...
class Bloedafname6:
    ...
    def run(self, child_name: str, child_age: int, robot_name: str="Hero"):
      ...
      #niet in originele script, in 4-6 word kracht niet uit gekozen maar alleen gepraat over een kracht. hier nu laten kiezen is betere (personalisatie)
        ...
        self.droomrobot.say('Merk maar eens hoe zo'n {kleur} lichtje je heel sterk maakt en je beschermt.')
        ...
        ### INTERVENTIE
            #dit deel staat niet in originele script, die begint elijk met weer terug op de fijne plek. 
        sleep(5)
